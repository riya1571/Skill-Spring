    ...
    <div className="min-h-screen bg-[#05070a] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-[#0d1117]/60 backdrop-blur-2xl border border-gray-800 rounded-[2.5rem] p-10 shadow-2xl relative z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black text-white uppercase tracking-tighter italic mb-2">Create Account</h1>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4 mb-6">
          <input 
            ...
            className="w-full bg-[#05070a] border border-gray-800 p-4 rounded-2xl text-sm text-white focus:border-purple-500 outline-none"
          />
          <input 
          ...
          <button 
            ...
            className="w-full bg-purple-600 hover:bg-purple-500 text-white px-6 py-4 rounded-2xl font-bold text-sm transition-all flex justify-center items-center"
          >
        ...
        <p className="text-center text-xs text-gray-500 mt-8 font-medium">
          Already have an account? <Link href="/login" className="text-purple-500 hover:text-purple-400 font-bold underline">Log in here</Link>
        </p>
      </div>
    </div>
  );
